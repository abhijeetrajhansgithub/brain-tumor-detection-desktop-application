...
class MainPage_04(QMainWindow):
    def __init__(self, username):
        ...
        self.setWindowTitle("Main Page v3.0.1")
    ...
    def show_home_frame(self):
        ...
        add_patient_button.clicked.connect(self.add_patient___func)
        add_patient_button.setStyleSheet(self.get_button_style())
        self.content_layout.addWidget(add_patient_button)
    ...
    def classify_image(self):
        ...
        self.output_label.setText(result + f" CS: {round(conf_score, 6)}")
        pass
