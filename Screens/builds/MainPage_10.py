...
from PyQt5.QtWidgets import (
    ...
    QRadioButton, QLineEdit, QMessageBox, QDialog, QAction, QTextEdit
)
from fpdf import FPDF
from plyer import notification


class MainPage_10(QMainWindow):
    def __init__(self, username):
        ...
        self.setWindowTitle("Main Page v4.2.0")
    ...
    def fClassify_Image(self):
        ...
        result__for_btcm_mdl_v01s = CLASSIFY_IMAGE_wBOTH_MODELS__for_btcm_mdl_v01s(h5_model__for_btcm_mdl_v01, keras_model__for_btcm_mdl_v01, image_path)
        result__for_btcm_mdl_21ms = CLASSIFY_IMAGE_wBOTH_MODELS__for_btcm_mdl_21ms(h5_model__for_btcm_mdl_21m, keras_model__for_btcm_mdl_21m, image_path)
