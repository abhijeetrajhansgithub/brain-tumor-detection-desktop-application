...
class ContrastedColorImageSegmentationDialog(QDialog):
    ...
    def display_images(self, images):
        ...
        for i, img in enumerate(images["bucketed_images"][::]):
            col = i % 3  # Ensures 3 images per row
